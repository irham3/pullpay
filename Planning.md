# PullPay x Optimism — Planning & Diferensiasi (Hackathon)
...
| [Collaborators.build](http://Collaborators.build) | On-chain USDC | Bot lacak merge → rilis USDC |
| [boss.dev](http://boss.dev) / boss-bounty | — | Bounty dari teks issue, bayar saat issue ditutup |
...
Spesifikasi penuh + prompt siap-tempel untuk generate UI (Google Stitch), pemetaan komponen reactbits, dan rekomendasi font/aset ada di halaman [PullPay — Stitch UI Prompt](https://app.notion.com/p/PullPay-Stitch-UI-Prompt-Anti-AI-Professional-a806a852f20e469f82cb4192b801e885?pvs=21).
