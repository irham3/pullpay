...
export function BountyCard({
  ...
  const cardClassName = cn(
    ...
    "before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-[#4285F4]/70 before:to-transparent before:opacity-0 before:transition-opacity",
    "after:absolute after:inset-y-0 after:left-0 after:w-1 after:bg-gradient-to-b after:from-[#4285F4] after:via-[#6EA8FF] after:to-transparent after:opacity-60",
    "hover:-translate-y-1 hover:border-[#4285F4]/55 hover:shadow-[0_0_32px_rgba(66,133,244,0.22)] hover:before:opacity-100",
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#4285F4] focus-visible:ring-offset-2 focus-visible:ring-offset-[#0B0F14]",
    className
  );

  const content = (
    <>
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(135deg,rgba(66,133,244,0.12),transparent_34%,rgba(66,133,244,0.06))] opacity-70" />
      <div className="relative">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <div className="flex items-center gap-2 font-mono text-sm text-[#AAB4C0]">
              <span className="grid h-7 w-7 shrink-0 place-items-center rounded-md border border-white/10 bg-[#0B0F14] text-[11px] text-[#4285F4]">
        ...
        <div className="mt-6 grid gap-3 border-t border-white/10 pt-4">
          <div className="flex items-start gap-2 text-xs text-[#AAB4C0]">
            <Wallet
              className="mt-0.5 h-3.5 w-3.5 shrink-0 text-[#4285F4]"
              strokeWidth={1.75}
            />
          ...
          <div className="flex items-end justify-between gap-3">
            <div>
              ...
              <div className="mt-1 font-mono text-3xl font-semibold tracking-normal text-[#F4F7FB] drop-shadow-[0_0_18px_rgba(66,133,244,0.45)]">
                {rewardAmount}
              </div>
            </div>

            <div className="hidden rounded-md border border-[#4285F4]/25 bg-[#4285F4]/10 px-2.5 py-2 sm:block">
              <div className="flex items-center gap-1.5 font-mono text-[11px] text-[#8CB8FF]">
        ...
        <div className="mt-4 flex items-center justify-between border-t border-white/10 pt-3 font-mono text-[11px] text-[#AAB4C0]">
          <span className="flex items-center gap-1.5">
            <GitPullRequest className="h-3.5 w-3.5 text-[#4285F4]" />
            merged PR pays
          </span>
  ...
  return (
    <span
      className={cn(
        ...
        verified
          ? "border-[#4285F4]/40 bg-[#4285F4]/10 text-[#8CB8FF]"
          : "border-[#4285F4]/35 bg-[#4285F4]/10 text-[#8CB8FF]"
      )}
    >
      <CircleDot
        className={cn(
